...
<div style={{width: '100%', height: '100%', background: 'var(--bg-page, #F7F7F8)', overflow: 'hidden', justifyContent: 'flex-start', alignItems: 'flex-start', display: 'inline-flex'}}>
  ...
  <div style={{flex: '1 1 0', paddingTop: 40, paddingBottom: 44, paddingLeft: 44, paddingRight: 44, overflow: 'hidden', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 24, display: 'inline-flex'}}>
    ...
    <div style={{alignSelf: 'stretch', justifyContent: 'flex-start', alignItems: 'stretch', gap: 20, display: 'inline-flex', flexWrap: 'wrap', alignContent: 'flex-start'}}>
      ...
      <div style={{width: 340, background: 'var(--bg-card, white)', borderRadius: 16, outline: '1px var(--border-default, #E4E4E7) solid', outlineOffset: '-1px', boxShadow: '0px 4px 12px -2px rgba(15,15,20,0.08)', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', overflow: 'hidden', display: 'inline-flex'}}>
        ...
        <div style={{alignSelf: 'stretch', flex: '1 1 auto', padding: 20, flexDirection: 'column', gap: 12, display: 'flex'}}>

          <div style={{justifyContent: 'flex-start', alignItems: 'center', alignContent: 'flex-start', gap: 6, minHeight: 46, display: 'flex', flexWrap: 'wrap'}}>
          ...
          <div style={{flexDirection: 'column', gap: 6, display: 'flex'}}>
            ...
            <div style={{color: 'var(--text-secondary, #6B6B70)', fontSize: 13, fontFamily: 'Inter', fontWeight: '400', lineHeight: '20px', height: 60, display: '-webkit-box', WebkitLineClamp: 3, WebkitBoxOrient: 'vertical', overflow: 'hidden'}}>Learn the fundamentals of writing clear, effective prompts for any AI tool — with real examples from day-to-day work.</div>
          </div>
          ...
          <div style={{paddingLeft: 20, paddingRight: 20, paddingTop: 12, paddingBottom: 12, background: 'var(--brand-yellow, #FFD400)', borderRadius: 999, marginTop: 'auto', justifyContent: 'center', alignItems: 'center', display: 'flex'}}>
      ...
      <div style={{width: 340, background: 'var(--bg-card, white)', borderRadius: 16, outline: '1px var(--border-default, #E4E4E7) solid', outlineOffset: '-1px', boxShadow: '0px 4px 12px -2px rgba(15,15,20,0.08)', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', overflow: 'hidden', display: 'inline-flex'}}>
        ...
        <div style={{alignSelf: 'stretch', flex: '1 1 auto', padding: 20, flexDirection: 'column', gap: 12, display: 'flex'}}>
          ...
          <div style={{flexDirection: 'column', gap: 6, display: 'flex'}}>
            ...
            <div style={{color: 'var(--text-secondary, #6B6B70)', fontSize: 13, fontFamily: 'Inter', fontWeight: '400', lineHeight: '20px', height: 60, display: '-webkit-box', WebkitLineClamp: 3, WebkitBoxOrient: 'vertical', overflow: 'hidden'}}>Automate budget commentary, spot anomalies in spreadsheets, and draft variance explanations using Copilot.</div>
          </div>
          <div style={{justifyContent: 'flex-start', alignItems: 'center', gap: 8, display: 'flex'}}>
          ...
          <div style={{paddingLeft: 20, paddingRight: 20, paddingTop: 12, paddingBottom: 12, background: 'var(--bg-card-alt, #F1F1F3)', borderRadius: 999, marginTop: 'auto', justifyContent: 'center', alignItems: 'center', display: 'flex'}}>
      ...
      <div style={{width: 340, background: 'var(--bg-card, white)', borderRadius: 16, outline: '1px var(--border-default, #E4E4E7) solid', outlineOffset: '-1px', boxShadow: '0px 4px 12px -2px rgba(15,15,20,0.08)', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', overflow: 'hidden', display: 'inline-flex'}}>
        ...
        <div style={{alignSelf: 'stretch', flex: '1 1 auto', padding: 20, flexDirection: 'column', gap: 12, display: 'flex'}}>
          ...
          <div style={{flexDirection: 'column', gap: 6, display: 'flex'}}>
            ...
            <div style={{color: 'var(--text-secondary, #6B6B70)', fontSize: 13, fontFamily: 'Inter', fontWeight: '400', lineHeight: '20px', height: 60, display: '-webkit-box', WebkitLineClamp: 3, WebkitBoxOrient: 'vertical', overflow: 'hidden'}}>Build on Part I — create forecast narratives, automate recurring slides, and review contracts faster with AI assistance.</div>
          </div>
          <div style={{justifyContent: 'flex-start', alignItems: 'center', gap: 8, display: 'flex'}}>
            <div style={{width: 28, height: 28, background: 'var(--bg-card-alt, #F1F1F3)', borderRadius: 9999, flexShrink: 0}} />
            <div style={{flexDirection: 'column', gap: 1, display: 'flex'}}>
      ...
      <div style={{width: 340, background: 'var(--bg-card, white)', borderRadius: 16, outline: '1px var(--border-default, #E4E4E7) solid', outlineOffset: '-1px', boxShadow: '0px 4px 12px -2px rgba(15,15,20,0.08)', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', overflow: 'hidden', display: 'inline-flex'}}>
        ...
        <div style={{alignSelf: 'stretch', flex: '1 1 auto', padding: 20, flexDirection: 'column', gap: 12, display: 'flex'}}>
          ...
          <div style={{flexDirection: 'column', gap: 6, display: 'flex'}}>
            ...
            <div style={{color: 'var(--text-secondary, #6B6B70)', fontSize: 13, fontFamily: 'Inter', fontWeight: '400', lineHeight: '20px', height: 60, display: '-webkit-box', WebkitLineClamp: 3, WebkitBoxOrient: 'vertical', overflow: 'hidden'}}>A step-by-step walkthrough of the prompt chain that turns raw status notes into a formatted weekly report in under five minutes.</div>
          </div>
          <div style={{justifyContent: 'flex-start', alignItems: 'center', gap: 8, display: 'flex'}}>
            <div style={{width: 28, height: 28, background: 'var(--brand-yellow-soft, #FFF6D6)', borderRadius: 9999, flexShrink: 0}} />
            <div style={{flexDirection: 'column', gap: 1, display: 'flex'}}>
      ...
      <div style={{width: 340, background: 'var(--bg-card, white)', borderRadius: 16, outline: '1px var(--border-default, #E4E4E7) solid', outlineOffset: '-1px', boxShadow: '0px 4px 12px -2px rgba(15,15,20,0.08)', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', overflow: 'hidden', display: 'inline-flex'}}>
        ...
        <div style={{alignSelf: 'stretch', flex: '1 1 auto', padding: 20, flexDirection: 'column', gap: 12, display: 'flex'}}>
          ...
          <div style={{flexDirection: 'column', gap: 6, display: 'flex'}}>
            ...
            <div style={{color: 'var(--text-secondary, #6B6B70)', fontSize: 13, fontFamily: 'Inter', fontWeight: '400', lineHeight: '20px', height: 60, display: '-webkit-box', WebkitLineClamp: 3, WebkitBoxOrient: 'vertical', overflow: 'hidden'}}>Use Copilot in Excel to clean datasets, write formulas in plain English, and generate summary charts without manual effort.</div>
          </div>
          <div style={{justifyContent: 'flex-start', alignItems: 'center', gap: 8, display: 'flex'}}>
            <div style={{width: 28, height: 28, background: 'var(--brand-yellow-soft, #FFF6D6)', borderRadius: 9999, flexShrink: 0}} />
            <div style={{flexDirection: 'column', gap: 1, display: 'flex'}}>
      ...
      <div style={{width: 340, background: 'var(--bg-card, white)', borderRadius: 16, outline: '1px var(--border-default, #E4E4E7) solid', outlineOffset: '-1px', boxShadow: '0px 4px 12px -2px rgba(15,15,20,0.08)', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', overflow: 'hidden', display: 'inline-flex'}}>
        ...
        <div style={{alignSelf: 'stretch', flex: '1 1 auto', padding: 20, flexDirection: 'column', gap: 12, display: 'flex'}}>
          ...
          <div style={{flexDirection: 'column', gap: 6, display: 'flex'}}>
            ...
            <div style={{color: 'var(--text-secondary, #6B6B70)', fontSize: 13, fontFamily: 'Inter', fontWeight: '400', lineHeight: '20px', height: 60, display: '-webkit-box', WebkitLineClamp: 3, WebkitBoxOrient: 'vertical', overflow: 'hidden'}}>Techniques for drafting, toning, and condensing emails using AI — without losing your voice or sounding like a robot.</div>
          </div>
          <div style={{justifyContent: 'flex-start', alignItems: 'center', gap: 8, display: 'flex'}}>
            <div style={{width: 28, height: 28, background: 'var(--bg-card-alt, #F1F1F3)', borderRadius: 9999, flexShrink: 0}} />
            <div style={{flexDirection: 'column', gap: 1, display: 'flex'}}>
      ...
      <div style={{width: 340, background: 'var(--bg-card, white)', borderRadius: 16, outline: '1px var(--border-default, #E4E4E7) solid', outlineOffset: '-1px', boxShadow: '0px 4px 12px -2px rgba(15,15,20,0.08)', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', overflow: 'hidden', display: 'inline-flex'}}>
        ...
        <div style={{alignSelf: 'stretch', flex: '1 1 auto', padding: 20, flexDirection: 'column', gap: 12, display: 'flex'}}>
          ...
          <div style={{flexDirection: 'column', gap: 6, display: 'flex'}}>
            ...
            <div style={{color: 'var(--text-secondary, #6B6B70)', fontSize: 13, fontFamily: 'Inter', fontWeight: '400', lineHeight: '20px', height: 60, display: '-webkit-box', WebkitLineClamp: 3, WebkitBoxOrient: 'vertical', overflow: 'hidden'}}>What every employee needs to know about data sensitivity, prompt safety, and responsible AI use at Renault GBS.</div>
          </div>
          <div style={{justifyContent: 'flex-start', alignItems: 'center', gap: 8, display: 'flex'}}>
            <div style={{width: 28, height: 28, background: 'var(--brand-yellow-soft, #FFF6D6)', borderRadius: 9999, flexShrink: 0}} />
            <div style={{flexDirection: 'column', gap: 1, display: 'flex'}}>
